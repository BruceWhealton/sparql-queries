...
SELECT DISTINCT ?Film_name ?link ?name_of_director ?director_wiki_link ?name_of_star ?star_wiki_link WHERE {
  ?film dcterms:subject category:Psychological_thriller_films ;
  ...
  ?star foaf:name ?name_of_star ;
         foaf:isPrimaryTopicOf ?star_wiki_link .
          
} ORDER BY DESC(?Film_name)
  LIMIT 100
EOQ;
?>
<!doctype html>
